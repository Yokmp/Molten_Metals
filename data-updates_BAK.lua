    ...
    if type(item) == "string" then
      table.insert(
        scrap_item,
        {
          type = "item",
          name = item.. "-scrap",
          icon = "__Ingredient_Scrap__/graphics/icons/" ..item.. "-MoltenIron.png", -- or "__Ingredient_Scrap__/graphics/icons/missing-icon.png",
    ...
    if type(item) == "string" then
      ...
      table.insert(
        scrap_recipes,
        {
          ...
          icons = {
            {
              icon = "__Ingredient_Scrap__/graphics/icons/" ..item.. "-MoltenIron.png",
              icon_size = 64, icon_mipmaps = 4,
...
MoltenIron.add_scrap(
  MoltenIron.get_scrap_results(),
  MoltenIron.get_scrap_item(),
  MoltenIron.get_scrap_recipes() )
