...
ylib.icon.icons:add("Molten_Metals", "graphics/icons", "molten-iron-ore", 64, 2, 0.5)
...
ylib.icon.icons:add("Molten_Metals", "graphics/icons", "advanced-caster", 64, 2, 0.5)
ylib.icon.icons:add("Molten_Metals", "graphics/icons", "basic-smelter", 64, 2, 0.5)
ylib.icon.icons:add("Molten_Metals", "graphics/icons", "advanced-smelter", 64, 2, 0.5)
...
ylib.icon.icons:add("Molten_Metals", "graphics/icons", "molten-aluminium-ore", 64, 2, 0.5)
ylib.icon.icons:add("Molten_Metals", "graphics/icons", "molten-lead-ore", 64, 2, 0.5)
ylib.icon.icons:add("Molten_Metals", "graphics/icons", "molten-titanium-ore", 64, 2, 0.5)
ylib.icon.icons:add("Molten_Metals", "graphics/icons", "molten-tungsten-ore", 64, 2, 0.5)
